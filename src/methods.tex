...
\noindent{\em Fractional anisotropy (FA) from DTI:}  A measurement of white matter integrity that may reveal the connectivity components of neurodegeneration \cite{}, potentially captures a different aspect of the disease process \cite{} and may differentiate tau and TDP-43 effects \cite{}.    
